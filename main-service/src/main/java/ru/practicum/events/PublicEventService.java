...
public class PublicEventService {
    ...
    public List<EventFullDto> getEvents(String text, List<Long> categories, boolean paid, String rangeStart, String rangeEnd,
    ...
    private List<Event> fetchEventsWithoutRange(String text, List<Long> categories, boolean paid, boolean onlyAvailable,
                                                String sort, Pageable pageable, LocalDateTime now) {
        if (text == null) {
    ...
    private List<Event> fetchEventsWithRange(String text, List<Long> categories, boolean paid, boolean onlyAvailable,
                                             String sort, Pageable pageable, LocalDateTime start, LocalDateTime end) {
        if (text == null) {
    ...
    private List<Event> fetchEventsWithoutTextWithoutRange(List<Long> categories, boolean paid, boolean onlyAvailable,
                                                           String sort, Pageable pageable, LocalDateTime now) {
        if (categories == null) {
    ...
    private List<Event> fetchEventsWithTextWithoutRange(List<Long> categories, boolean paid, boolean onlyAvailable, String sort,
                                                        Pageable pageable, String text, LocalDateTime now) {
        if (categories == null) {
    ...
    private List<Event> fetchEventsWithoutCategoriesWithoutTextWithoutRange(boolean paid, boolean onlyAvailable, String sort,
    ...
    private List<Event> fetchEventsWithCategoriesWithoutTextWithoutRange(boolean paid, boolean onlyAvailable,
                                                                         String sort, Pageable pageable,
                                                                         List<Long> categories, LocalDateTime now) {
        if (paid) {
            if (onlyAvailable) {
                return sort.equals("VIEWS")
    ...
    private List<Event> fetchEventsWithoutCategoriesWithTextWithoutRange(boolean paid, boolean onlyAvailable, String sort,
                                                                         Pageable pageable, String text, LocalDateTime now) {
        if (paid) {
            if (onlyAvailable) {
                return sort.equals("VIEWS")
    ...
    private List<Event> fetchEventsWithCategoriesWithTextWithoutRange(boolean paid, boolean onlyAvailable, String sort,
                                                                      Pageable pageable, String text, List<Long> categories,
                                                                      LocalDateTime now) {
        if (paid) {
            if (onlyAvailable) {
                return sort.equals("VIEWS")
    ...
    private List<Event> fetchEventsWithoutTextWithRange(List<Long> categories, boolean paid, boolean onlyAvailable,
                                                        String sort, Pageable pageable, LocalDateTime start,
                                                        LocalDateTime end) {
        if (categories == null) {
    ...
    private List<Event> fetchEventsWithTextWithRange(List<Long> categories, boolean paid, boolean onlyAvailable,
                                                     String sort, Pageable pageable, String text, LocalDateTime start,
                                                     LocalDateTime end) {
        if (categories == null) {
    ...
    private List<Event> fetchEventsWithoutCategoriesWithoutTextWithRange(boolean paid, boolean onlyAvailable,
                                                                         String sort, Pageable pageable,
    ...
    private List<Event> fetchEventsWithCategoriesWithoutTextWithRange(boolean paid, boolean onlyAvailable, String sort,
                                                                      Pageable pageable, List<Long> categories,
                                                                      LocalDateTime start, LocalDateTime end) {
        if (paid) {
            if (onlyAvailable) {
                return sort.equals("VIEWS")
    ...
    private List<Event> fetchEventsWithoutCategoriesWithTextWithRange(boolean paid, boolean onlyAvailable, String sort,
                                                                      Pageable pageable, String text, LocalDateTime start,
                                                                      LocalDateTime end) {
        if (paid) {
            if (onlyAvailable) {
                return sort.equals("VIEWS")
    ...
    private List<Event> fetchEventsWithCategoriesWithTextWithRange(boolean paid, boolean onlyAvailable, String sort,
                                                                   Pageable pageable, String text, List<Long> categories,
                                                                   LocalDateTime start, LocalDateTime end) {
        if (paid) {
            if (onlyAvailable) {
